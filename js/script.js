...
//menu//
//To update the menu simply change the text within each catagory for example
//      title is what shows in red and description is the black text beneth
//      category should NOT be changed 
//note: Deep Dish is repeated so that it is automatically displayed when loading the page
//      if you want to change anything on deep dish change both sections
const Deep_Dish =[
     //Deep Dish//
     {
        id:1,
  ...
  const menu =[
    ...
    {
        id:25,
        title: "House Cheeseburger",
        description: "Tomato, lettuce, onions with our house made burger sause (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:26,
        title: "House Patty Melt",
        description: "Double patty with Swiss and American cheese, grilled onions and our zesty house sauce on rye (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:27,
        title: "Maxwell Street Polish Sausage",
        description: "Polish Sausage, mustard, poppy seed buns, sport peppers and grilled onions (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:28,
        title: "Italian Beef",
        description: "Thinly sliced slow-roasted beef served on a 6” turano roll with your choice of sweet peppers and hot giardiniera. Dipped or Baptized (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:29,
        title: "Meatball Sub",
        description: "House made meatballs and maranara sauce on a 6 inch roll topped with parmigiano reggiano (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:30,
        title: "Gyro",
        description: "A lamb and beef blend served with tomatoes, onions, feta cheese and our house tzatziki sauce (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:31,
        title: "Chicago Dog",
        description: "A grilled Vienna all-beef frank in a hot, steamed bun topped with fresh tomato, fresh onions, pickle spear, relish, sport peppers, tangy French's mustard and sprinkled with celery salt (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:32,
        title: "Chicken Club",
        description: "Fried chicken topped with bacon, lettuce, tomato, pepper jack cheese, and mayo (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
    {
        id:33,
    ...
    },
    {
        id:34,
        title: "Fish Sandwich",
        description: "Beer battered haddockwith american cheese lettuce and tarter sauce on a hogie roll (house cut or crinkle fries)",
        Category: "Sandwiches",
    },
